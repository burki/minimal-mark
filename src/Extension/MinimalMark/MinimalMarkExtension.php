...
namespace MinimalMark\Extension\MinimalMark;
...
use MinimalMark\Extension\MinimalMark\Delimiter\Processor\EmphasisStrongDelimiterProcessor;
use Nette\Schema\Expect;

final class MinimalMarkExtension implements ConfigurableExtensionInterface
{
    public function configureSchema(ConfigurationBuilderInterface $builder): void
    {
        $builder->addSchema('minimalmark', Expect::structure([
            'use_asterisk' => Expect::bool(false),
    ...
    public function register(EnvironmentBuilderInterface $environment): void
    {
        ...
        if ($environment->getConfiguration()->get('minimalmark/use_asterisk')) {
            $environment->addDelimiterProcessor(new EmphasisStrongDelimiterProcessor('*'));
        }

        if ($environment->getConfiguration()->get('minimalmark/use_underscore')) {
            $environment->addDelimiterProcessor(new EmphasisStrongDelimiterProcessor('_'));
        }
    }
}
